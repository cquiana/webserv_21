...
print('<a class="btn btn-lg btn-primary">Get запрос</a>')
print('<a class="btn btn-lg btn-danger">Delete запрос</a>')
print('</div></div>')
...
print('<div class="d-grid"><a class="btn btn-dark btn-lg mt-3">Redirect to Google</a></div></div></div></div>')
